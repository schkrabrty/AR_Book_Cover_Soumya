...
{
    private GameObject picture_button, picture_1, picture_2, picture_3, picture_4, picture_close_button, short_details_button, more_details_button, short_details_text, more_details_text;
    ...
    void Start()
    {
        ...
        picture_4 = GameObject.Find("ImageTargetBackCover/Picture_4");
